...
This asset license does not apply to the source code, scripts, MCP server, or
desktop widget implementation. Those are covered by the MIT License in
`LICENSE`.
